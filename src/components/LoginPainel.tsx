...
export default function LoginPainel({handleRegisterShowing}: Props) {

    const [userInput, setUserInput] = React.useState('')

  return (
    <div className="w-[336px] h-[416px] rounded-l-xl font-sans flex flex-col items-center p-3 px-6 col-start-1 row-start-1 ">
        <div className="text-4xl font-bold mt-4 ">Login</div>
        <Form.Root onSubmit={(e)=> { console.log(e)}} className='w-full mt-8 flex flex-col'>
            <Form.Field name='user'>
                <div>
                    ...
                    <div className=' bg-background rounded-md h-12 relative'>
        ...
        <div className='text-sm mt-2 font-thin hover:text-primary hover:font-semibold' onClick={handleRegisterShowing}> Não possui uma conta? Registre-se aqui </div>
    </div>
